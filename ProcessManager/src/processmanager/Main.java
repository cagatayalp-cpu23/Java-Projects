...
public class Main {
	...
	public static void main(String[] args) {
		...
		PM.add_process(u1, "Process2", 6);
		
		
		PM.add_process(u3, "Process3", 3);
		PM.add_process(u1, "Process6", 7);
		PM.add_process(u2, "Process2", 4);
		...
		try {
			PM.remove_process("Process2");
		}
		catch(Exception e){
			System.out.println(e);
			
		}
		System.out.println("After process 2 removed");
		...
		try {
			PM.remove_process("Olmayan Process");
		}
		catch(Exception e){
			System.out.println(e);
